...
class ServerEngine {
    constructor() {
        ...
        this.ball = Bodies.circle(800, 450, 100, {
          density: 0.04,
          friction: 0.2,
          frictionAir: 0.00001,
          restitution: 0.8,
        ...
        this.topLeft = Bodies.rectangle(65, 265, 500, 700, {
          isStatic: true,
          collisionFilter: {
            group: 1,
            category: 0x1000,
        ...
        this.leftGoalBack = Bodies.rectangle(-235, 865, 500, 700, {
          isStatic: true,
          collisionFilter: {
            group: 1,
            category: 0x1000,
        ...
        this.bottomLeft = Bodies.rectangle(65, 1535, 500, 700, {
          isStatic: true,
          collisionFilter: {
            group: 1,
            category: 0x1000,
        ...
        this.topRight = Bodies.rectangle(3735, 265, 500, 700, {
          isStatic: true,
          collisionFilter: {
            group: 1,
            category: 0x1000,
        ...
        this.rightGoalBack = Bodies.rectangle(4035, 865, 500, 700, {
          isStatic: true,
          collisionFilter: {
            group: 1,
            category: 0x1000,
        ...
        this.bottomRight = Bodies.rectangle(3735, 1535, 500, 700, {
          isStatic: true,
          collisionFilter: {
            group: 1,
            category: 0x1000,
    ...
    //     World.add(this.world, this.rightGoal);
       ...
       this.leftSensor = Bodies.rectangle(65, 865, 500, 700, {
          isStatic: true,
          isSensor: true,
          render: {
            visible: false
      ...
      this.rightSensor = Bodies.rectangle(3785, 865, 500, 700, {
          isStatic: true,
          isSensor: true,
          render: {
            visible: false
