...
class ServerEngine {
    constructor() {
        ...
        this.leftExplosion = Bodies.circle(-1000, 900, 800, {
          density: 1,
          friction: 0.1,
          frictionAir: 0.00001,
          restitution: 0.8,
        ...
        this.rightExplosion = Bodies.circle(6900, 900, 500, {
          density: 0.5,
          friction: 0.1,
          frictionAir: 0.00001,
          restitution: 0.8,
        ...
        // Matter.Body.setDensity(this.ball, 0.101)
        World.add(this.world, this.ball);
        World.add(this.world, this.leftExplosion)
